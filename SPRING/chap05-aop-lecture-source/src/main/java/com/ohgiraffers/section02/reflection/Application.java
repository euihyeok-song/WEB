...
public class Application {
    public static void main(String[] args) {
         ...
         *   스프링 프레임워크, Mybatis, 하이버네이트(JPA), jackson(json) 등의 라이브러리에서 사용된다.
         *   스프링에서는 런타임 시 개발자가 등록한 Bean을 Application 내부에서 다루기 위한 기술
         *
         * 필기.
        ...
        try{
            ...
            /* 설명. String 배열을 만들기 위해선 [Ljava.lang,String; 을 사용해야함 */
        ...
        try {
            Account acc = (Account) constructors[0].newInstance("20", "110-223-23456","1234", 10000);
        ...
        try {
            /* 설명. [2]는 Account파일에 getBalance()의 this를 의미*/

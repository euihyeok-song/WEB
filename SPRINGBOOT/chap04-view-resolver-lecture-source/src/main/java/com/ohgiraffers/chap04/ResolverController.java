...
public class ResolverController {
     ...
     /* 설명. 서블릿 때와 마찬가지로 Forwading을 통해 값을 전달할 수 있다. */
    @GetMapping("string")
    ...
    /* 설명. 서블릿 때와 마찬가지로 redirect를 하지만 파라미터를 활용하지 않고서는 전달할 수 없다(Spring은 해법들을 제공) */
...
//        rttr.addFlashAttribute("flashMessage2", "ModelAndVie를 이용한 redirect attr");
        mv.setViewName("redirect:/");
